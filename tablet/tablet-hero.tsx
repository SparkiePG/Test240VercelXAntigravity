...
export default function TabletHero() {
    ...
    return (
        <section id="tablet-hero" className="relative h-[100svh] flex items-center justify-center overflow-hidden snap-start snap-always">
            ...
            <div
                ...
                style={{
                    background: "linear-gradient(to bottom, rgba(0,0,0,0.35) 0%, rgba(0,0,0,0.4) 50%, rgba(0,0,0,0.55) 100%)",
                }}
            />

            <div className="hero-overlay absolute inset-0 pointer-events-none z-10" />

            {/* Content - Larger text for tablet, optical centering */}
            <div className="relative z-20 w-full max-w-4xl mx-auto text-center px-8 flex flex-col justify-center items-center h-full pb-20">
                <div
                    className={`transition-all duration-1000 delay-300 ${mounted ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
                        }`}
                >
                    <h1 className="font-serif text-white text-4xl md:text-5xl font-medium leading-[1.1] mb-6 text-balance drop-shadow-[0_2px_3px_rgba(0,0,0,0.4)]">
